...
Perk Property Armorer03 auto
Perk Property Armorer04 auto
Perk Property Science01 auto
Perk Property Science02 auto
Perk Property Science03 auto
Perk Property Science04 auto

MiscObject Property ArmorerPerkToken Auto
MiscObject Property ArmorerPerk2Token Auto
MiscObject Property ArmorerPerk3Token Auto
MiscObject Property ArmorerPerk4Token Auto
MiscObject Property SciencePerkToken Auto
MiscObject Property SciencePerk2Token Auto
MiscObject Property SciencePerk3Token Auto
MiscObject Property SciencePerk4Token Auto
				...
				If !activatingActor.WornHasKeyword( powerArmorKW )
					...
					If nearbyPowerArmors.Length > 0
						...
						if( nearestPowerArmor )
							...
							;Add the repair tokens to the player							
							AddRepairTokens()
...
Function AddRepairTokens()
		debug.trace("Adding repair tokens to player ")
		RegisterForMenuOpenCloseEvent("PipboyMenu")
		RegisterForMenuOpenCloseEvent("ContainerMenu")
		RegisterForMenuOpenCloseEvent("BarterMenu")
		if PlayerRef.hasperk(armorer04)
			PlayerRef.additem(ArmorerPerk4Token, 400, true)
			PlayerRef.additem(ArmorerPerk3Token, 300, true)
			PlayerRef.additem(ArmorerPerk2Token, 200, true)
			PlayerRef.additem(ArmorerPerkToken, 100, true)
		elseif PlayerRef.hasperk(armorer03)
			PlayerRef.additem(ArmorerPerk4Token, 3, true)
			PlayerRef.additem(ArmorerPerk3Token, 300, true)
			PlayerRef.additem(ArmorerPerk2Token, 200, true)
			PlayerRef.additem(ArmorerPerkToken, 100, true)
		elseif PlayerRef.hasperk(armorer02)
			PlayerRef.additem(ArmorerPerk4Token, 2, true)
			PlayerRef.additem(ArmorerPerk3Token, 2, true)
			PlayerRef.additem(ArmorerPerk2Token, 200, true)
			PlayerRef.additem(ArmorerPerkToken, 100, true)
		elseif PlayerRef.hasperk(armorer01)
			PlayerRef.additem(ArmorerPerk4Token, 1, true)
			PlayerRef.additem(ArmorerPerk3Token, 1, true)
			PlayerRef.additem(ArmorerPerk2Token, 1, true)
			PlayerRef.additem(ArmorerPerkToken, 100, true)
		endif
		if PlayerRef.hasperk(Science04)
			PlayerRef.additem(SciencePerk4Token, 400, true)
			PlayerRef.additem(SciencePerk3Token, 300, true)
			PlayerRef.additem(SciencePerk2Token, 200, true)
			PlayerRef.additem(SciencePerkToken, 100, true)
		elseif PlayerRef.hasperk(Science03)
			PlayerRef.additem(SciencePerk4Token, 3, true)
			PlayerRef.additem(SciencePerk3Token, 300, true)
			PlayerRef.additem(SciencePerk2Token, 200, true)
			PlayerRef.additem(SciencePerkToken, 100, true)
		elseif PlayerRef.hasperk(Science02)
			PlayerRef.additem(SciencePerk4Token, 2, true)
			PlayerRef.additem(SciencePerk3Token, 2, true)
			PlayerRef.additem(SciencePerk2Token, 200, true)
			PlayerRef.additem(SciencePerkToken, 100, true)
		elseif PlayerRef.hasperk(Science01)
			PlayerRef.additem(SciencePerk4Token, 1, true)
			PlayerRef.additem(SciencePerk3Token, 1, true)
			PlayerRef.additem(SciencePerk2Token, 1, true)
			PlayerRef.additem(SciencePerkToken, 100, true)
		endif
EndFunction
...
Function UndoWorkbenchStuff()
	...
	debug.trace("Removing repair tokens from player ")
	PlayerRef.RemoveItem(ArmorerPerkToken, -1, true)
	PlayerRef.RemoveItem(SciencePerkToken, -1, true)
	PlayerRef.RemoveItem(ArmorerPerk2Token, -1, true)
	PlayerRef.RemoveItem(SciencePerk2Token, -1, true)
	PlayerRef.RemoveItem(ArmorerPerk3Token, -1, true)
	PlayerRef.RemoveItem(SciencePerk3Token, -1, true)
	PlayerRef.RemoveItem(ArmorerPerk4Token, -1, true)
	PlayerRef.RemoveItem(SciencePerk4Token, -1, true)
