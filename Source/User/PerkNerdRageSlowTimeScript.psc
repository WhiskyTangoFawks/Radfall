...
Event OnEffectStart(Actor akTarget, Actor akCaster)
	...
	Game.GetPlayer().AddPerk(isNerdRaging)
...
Event OnEffectFinish(Actor akTarget, Actor akCaster)
	;FadeOutImod.popto()	
	ImodEffect.Remove()
	Game.GetPlayer().RemovePerk(isNerdRaging)
...
Event OnKill(Actor akVictim)
	If game.GetPlayer().HasPerk(isNerdRaging) == true && game.GetPlayer().HasPerk(NerdRage03) == true
		Game.GetPlayer().RestoreValue(ActionPoints, HealAmount)
	Endif
EndEvent
...
Perk Property isNerdRaging Auto Const
